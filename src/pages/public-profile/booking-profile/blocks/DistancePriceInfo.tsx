...
interface DistancePriceInfoProps {
  data: any;
}

const DistancePriceInfo: React.FC<DistancePriceInfoProps> = ({ data }) => {
  ...
  return (
    <div className="card pb-2.5">
      <div className="card-header" id="distance-price-info">
        <h3 className="card-title">Distance & Price Information</h3>
      </div>
