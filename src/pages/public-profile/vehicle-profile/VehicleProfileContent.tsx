...
import { VehicleIdInfo } from "./blocks/VehicleIdInfo";
import { PickupInfo } from "./blocks/PickupInfo";
import { DropOffInfo } from "./blocks/DropOffInfo";
...
interface VehicleProfileContentProps {
  data: any;
}

const VehicleProfileContent: React.FC<VehicleProfileContentProps> = ({
  data,
}) => {
