...
const GeneralInfo: React.FC<GeneralInfoProps> = ({ data }) => {
  const items: IGeneralInfoItems = [
    { label: "baseFare:", info: data.baseFare },
    { label: "additionalFarePerKm:", info: data.additionalFarePerKm },
    { label: "minWeightCapacity:", info: data.minWeightCapacity },
    { label: "minWeightCapacity:", info: data.minWeightCapacity },
    { label: "isActive:", info: data.isActive },
    // {
    //   label: "Status:",
