...
// import { type TMenuConfig, type IMenuItemConfig } from "@/components/menu";

// export const getMenuSidebar = (authToken: string, getUserType: (token: string) => string): TMenuConfig => {
//   const menuItems: (IMenuItemConfig | null)[] = [
//     {
//       heading: "Admin",
//     },
...
//   const filteredMenuItems = menuItems.filter((item): item is IMenuItemConfig => item !== null);
...
/**
 * Returns the sidebar menu configuration based on the auth token and a helper function to get the user type.
 *
...
export const getMenuSidebar = (
  ...
  const filteredMenuItems = menuItems.filter(
    (item): item is IMenuItemConfig => item !== null
  );
...
/**
 * Export MENU_SIDEBAR as an alias for getMenuSidebar.
 * This allows consumer code to import { MENU_SIDEBAR } from the module.
 */
